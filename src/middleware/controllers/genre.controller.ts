...
export async function create(req, res) {
	const resGen = new responseGenerator(res, "genre", messageTypes.CREATE);
...
export async function getAll(req, res) {
	const resGen = new responseGenerator(res, "genre", messageTypes.GET_ALL);
...
export async function pages(req, res) {
	const resGen = new responseGenerator(res, "genre", messageTypes.GET_PAGES);
	...
	try {
		const data = await genreService.getPages(page - 1, items_per_page);
...
export async function getOne(req, res) {
	const resGen = new responseGenerator(res, "genre", messageTypes.GET_ONE);
	try {
		const data = await genreService.getOne(req.params.id);
		return resGen.data(responseTypes.SUCCESS, data);
	} catch (e) {
		return resGen.error(responseTypes.SERVER_ERROR, e.message);
	}
...
export async function update(req, res) {
	const resGen = new responseGenerator(res, "genre", messageTypes.UPDATE);
	try {
...
export async function deleteOne(req, res) {
	const resGen = new responseGenerator(res, "genre", messageTypes.DELETE);
	try {
		await genreService.deleteOne(req.params.id);
